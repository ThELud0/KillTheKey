...
public class Menu_Personalisation_Universe {
	...
	/***** TITRE *****/
	String titre = "CHOOSE THE UNIVERSE";
	...
	/***** CONSTRUCTEUR *****/
	public Menu_Personalisation_Universe() {}
	...
	/********** ACTIONS **********/
	 ...
	 EventHandler<ActionEvent> clickOK = new EventHandler<>() {
		 public void handle(ActionEvent e) {
			 test.changeimage("universe", image, Stock.choixId);
			 try {
					test.obeitmoi();
	...
	public void start() {
		...
		/*** LISTE ***/ 
		liste.add("UniversNoir.jpeg");
		liste.add("UniversBleu.jpeg");
		liste.add("UniversDore.jpeg");
		liste.add("UniversLigneBleue.jpg");
		liste.add("UniversLignes.jpg");
		liste.add("UniversRouge.jpg");
		liste.add("UniversSpace.jpg");
