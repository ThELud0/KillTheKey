...
public class Menu_Personalisation_Home {
	...
	/***** CONSTRUCTEUR *****/
	public Menu_Personalisation_Home() {}
	...
	/********** ACTIONS **********/
	 ...
	 EventHandler<ActionEvent> clickOK = new EventHandler<>() {
		 public void handle(ActionEvent e) {
			 test.changeimage("home", image, Stock.choixId);
			 try {
					test.obeitmoi();
	...
	public void start() {
		...
		/*** LISTE ***/
		liste.add("PlaneteTerre.png");
		liste.add("PlaneteJupiter.png");
		liste.add("PlaneteMars.png");
		liste.add("PlaneteMercure.png");
		liste.add("PlanetePluton.png");
		liste.add("PlaneteSaturne.png");
		liste.add("PlaneteVenus.png");
