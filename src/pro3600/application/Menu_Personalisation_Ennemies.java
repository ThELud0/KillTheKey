...
public class Menu_Personalisation_Ennemies {
	/***** CONSTANTES *****/
	...
	/***** "ZONE" IMAGE *****/
	String image = "VaisseauRequin.png";
	...
	/***** TITRE *****/
	String titre = "CHOOSE WHO YOU'RE KILLING";
	...
	/***** CONSTRUCTEUR *****/
	public Menu_Personalisation_Ennemies() {}
	...
	EventHandler<ActionEvent> clickOK = new EventHandler<>() {
		public void handle(ActionEvent e) {
			test.changeimage("ennemies", image, Stock.choixId);
			try {
				test.obeitmoi();
	...
	public void start() {
		...
		/*** LISTE ***/ 
		liste.add("VaisseauRequin.png");
		liste.add("VaisseauFaucon.png");
		liste.add("VaisseauMinecraft.png");
		liste.add("VaisseauTieFighter.png");
		liste.add("VaisseauTriangle.png");
		liste.add("VaisseauTurboSquid.png");
		liste.add("VaisseauVulcain.png");
